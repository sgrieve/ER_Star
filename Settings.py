...
Prefix = 'GM' #Must be wrapped in quotes and match the prefix used in ER_STAR.cpp
...
PatchFlag = 1 #Use 1 to plot the patch data and 0 to not plot it.
...
GabilanMesa = True #True to plot the data, False to exclude it.
