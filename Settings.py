...
Path = '/home/s0675405/ER_Star_Data/' #Must be wrapped in quotes with a trailing slash eg 'home/user/data/'
...
BinFlag = 'raw' #Use 'raw' to bin the raw data, 'patches' to bin the hilltop patch
...
MinBinSize = 10 #Number of data points required for a bin to be valid. eg 5,20,100
...
Sc_Method = 'patches' #Either input a real number eg 0.8,1.2,1.052 to set the Sc value and avoid
...
NumBootsraps = 100 #Number of itewrations for the bootstrapping procedure.
